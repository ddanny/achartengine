...
public class DonutChartActivity extends GraphicalActivity {
  ...
  protected AbstractChart generateChartFromContentProvider(Uri intent_data) {
    ...
    List<List<Number>> x_axis_series = stripSeriesDatumLabels( sorted_series_list.get( ContentSchema.X_AXIS_INDEX ) );
    List<List<Number>> y_axis_series = stripSeriesDatumLabels( sorted_series_list.get( ContentSchema.Y_AXIS_INDEX ) );
